                            ...
                            <form onSubmit={this.postJobSumbit}> <br />
                                <h2> Job Posting Form</h2>
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="text" name="jobposition" id="jobposition" required placeholder="Enter position"   value={this.state.jobposition}
                                                            onChange={this.handleInputChange}/></td>
                                        </tr>
                                        <tr>
                                            <th><label htmlFor="jdesc"><b>Job Description</b></label></th>
                                            <td>
                                                <textarea rows="4" cols="57" id="jdesc" name="jdesc" required
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="date" id="date"  required value={this.state.date}
                                                            onChange={this.handleInputChange} />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label htmlFor="location"><b>Location</b></label></th>
                                            <td><input type="text" name="location" id="location" required placeholder="Enter location"  value={this.state.location}
                                                            onChange={this.handleInputChange} /> </td>
                                        </tr>
                                        <tr>
                                            <td colSpan="2">
