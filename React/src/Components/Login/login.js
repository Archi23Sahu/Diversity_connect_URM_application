...
import {AppUrl, loginReponse} from '../../Constants';
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.isLogin && !prevState.isLogin) {
            if(this.state.role === "Academia"){
                ...
                this.props.navigate('/Urmdashboard');
            }else if(this.state.role === "Dei"){
                this.props.navigate('/Deidashboard');
            }else if(this.state.role === "Recruiter"){
                this.props.navigate('/Recruiterdashboard');
                ...
                <div className="container">
                    <section className="card">
                        ...
                        <div className="button-container">
                            ...
                            <Link to={AppUrl.forgetPassword} className="button">Forgot Password</Link>
                        </div>
                    </section>
                </div>
