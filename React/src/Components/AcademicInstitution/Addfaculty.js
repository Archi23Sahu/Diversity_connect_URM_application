                            ...
                            <table className="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="subject" id="subject" placeholder="Enter subject" required
                                        value={setFacultyDetails.subject}
                                        onChange={handleInputChange}/></td>
                                    </tr>
                                    <tr>
                                        <th><label htmlFor="classtype"><b>Class</b></label></th>
                                        <td><input type="text" name="classtype" id="classtype" placeholder="Enter class" required
