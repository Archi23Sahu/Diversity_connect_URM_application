...
import Reporturm from './Components/URMcandidate/Reporturm';
...
class App extends Component{
  ...
  return (
    ...
    <Routes>
          ...
          <Route path="/Academiadashboard/:id" component={Academiadashboard} element={this.state.isLogin ? <Academiadashboard/>: <Logout onLogin={this.handleIsLogin}/>}></Route>
          ...
          <Route path="/Urmdashboard/:id" component={Urmdashboard} element={this.state.isLogin ? <Urmdashboard/>: <Logout onLogin={this.handleIsLogin}/>}></Route>
          ...
          <Route path="/Reporturm/:id" component={Reporturm} element={<Reporturm/>}></Route>
          <Route path={AppUrl.Urmcheckjobroles} element={<Urmcheckjobroles/>}></Route>
          <Route path={AppUrl.Chaturm} element={<Chaturm/>}></Route>

          <Route path="/Deidashboard/:id" component={Deidashboard}  element={this.state.isLogin ? <Deidashboard/>: <Logout onLogin={this.handleIsLogin}/>}></Route>
          ...
          <Route path={AppUrl.Admindashboard} element={this.state.isLogin ? <Admindashboard/>: <Logout onLogin={this.handleIsLogin} />}></Route>
